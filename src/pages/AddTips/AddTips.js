...
const AddTips = () => {
    ...
    const SaveTip = () => {
        ...
        bodyFormData.append('tipText', tipMessage);
        bodyFormData.append('imageUrl', imageFile);
        axios({
            method: "POST",
            url: "http://localhost:5000/api/v1/tips/create",
            data: bodyFormData,
            ...
            <section class="text-gray-600 body-font bg-white h-screen">
                <div class="container px-5 py-4 mx-auto">
                    <div class="flex flex-col text-left w-full">
                        <h1 class="text-lg font-medium title-font text-gray-600 pl-3">Add New Tips</h1>
                    </div>
                    ...
                    <div className="text-right px-10 mb-4 space-x-4">
                        ...
                        <Button variant="contained" color="primary" onClick={() => SaveTip()}>
                            Save
                        </Button>
                    </div>
                            ...
                            <div className="w-full">
                                <div class="overflow-hidden relative w-72">
                                    <button class="bg-blue-500 rounded-sm hover:bg-blue-light text-white font-bold py-2 px-4 w-full inline-flex items-center">
                                        ...
                                        <span class="ml-2">Upload Tips Image</span>
                                    </button>
                                    <input
